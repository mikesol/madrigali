...
bassCat = \relative c' {
  ...
  ais8 r8 a4. a8 ~ |
  a4. r8 gis'4 ~ |
  %c'16 aes g fis r16 g'8. ~ g16 fis8. |
  %r8. fis16 ~ fis8. e16 ~ e4 |
  %c'16 aes g fis r4 r8 c'16 b |
  %r16 c b bes r8. c16 b bes r8 |
  %c16 b r8 r16 a r8 b16 bes r8 |
  %cis8 c gis b r4 |
  %fis8 a gis r4. |
  %g4 b fis' ~ |
  %fis8 f,8 ~ f2 |
  ...
  \new ChoirStaff <<
    \new Staff \with { instrumentName = #"Marie" %shortInstrumentName = #"M."
      ...
      \new Voice = "soprano" { #(set-accidental-style 'neo-modern) \numericTimeSignature << { \set Staff.midiMaximumVolume = #1.0
        \sopranoBeginning \sopranoHolyShit \sopranoUbiquitous \sopranoCat \sopranoEnd } { \marksBeginning \marksHolyShit \marksUbiquitous \marksCat \marksEnd } >> }
    ...
    \new Staff \with { \override VerticalAxisGroup #'staff-staff-spacing = #'((basic-distance . 1)
      ...
      \new Voice = "alto" { #(set-accidental-style 'neo-modern) \numericTimeSignature \set Staff.midiMaximumVolume = #1.0
        \altoBeginning \altoHolyShit \altoUbiquitous \altoCat \altoEnd }
    ...
    \new Staff \with { instrumentName = #"Ryan" %shortInstrumentName = #"R."
      ...
      \new Voice = "tenor" { #(set-accidental-style 'neo-modern) \numericTimeSignature \set Staff.midiMaximumVolume = #1.0
        \tenorBeginning \tenorHolyShit \tenorUbiquitous \tenorCat \tenorEnd }
    ...
    \new Staff \with { instrumentName = #"Eudes" %shortInstrumentName = #"P." %\markup { \concat { E \super u . } }
      ...
      \new Voice = "bass" { #(set-accidental-style 'neo-modern) \numericTimeSignature \set Staff.midiMaximumVolume = #1.0
        \bassBeginning \bassHolyShit \bassUbiquitous \bassCat \bassEnd }
