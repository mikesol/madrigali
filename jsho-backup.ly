...
vacuumENGLISH = \markup \italic { allumez l'aspirateur }
vacuumFRENCH = \markup { \italic \column { "turn on the" "vacuum cleaner" }}
...
ditz = {
  ...
  s1-"tu sais j'ai l'impression qu'on ne" \break \bar "" s1-"parle que de cul au boulot eh ben c'est bizarre ça parque que nous on ne parle que de" \bar "" \break
  \unFatText
  \unMonoShift
...
soprano = \relative c' {
  ...
  \stemNeutral
  \times 2/3 { \footnote "" #'(0 . 0) #'NoteHead "* Tremoli de triangle pendant les \"pitié\"." c,16^\mf^"*" c c } \times 2/3 { c c c } \times 2/3 { c c c } \times 2/3 { c c c } |
  \time 3/4
  R2. |
  \time 5/8
...
%}
  ...
  \berioGoalposts
  r8. c16^\mf^\chipmunkFRENCH r4 \cross c,16_\clickFRENCH a'-. r8 r16 \bendAfter #-2 e'8. |
  r8 d8-. r8 c16 c r8 \times 2/3 { r16 b16 b } r16 a16 r8 |
  r8 c r4 r16 a16^\responseFRENCH ( \bendAfter #-3 f'4 ) r8 |
  r8. b,16 e8-. c-. r16 d16 r8 b16 b r e |
  \times 2/3 { r8 \diamond \bendAfter #2 c4^\whistleFRENCH } r4 \bendAfter #-2 e8 r8 r8 d16 d |
  ...
  \footnote "" #'(0 . 0) #'NoteHead \tappingagainFRENCH
  ...
  f,1^\ppp ~ |
  \time 6/4
  f4 \air \clef percussion \ctip \stemTrans \sustainG c4*4^\>^\bravoFRENCH \glissando \grace { \hideNotes c8 \unHideNotes } r4\! \normalG |
  \time 4/4
  \normal
  \cricket
  \footnote "" #'(0 . 0) #'NoteHead \waterFRENCH
  \berioGoalposts
...
alto = \relative c' {
  ...
  \normal
  \clef "treble"
  r8 g4. c8 c c4 c8 \cricket \clef percussion \times 2/3 { r8 c,16^\mp }
  \time 6/16
  c16 c c c c c |
  c16 c c c c c |
  c16 c c c c r16 |
  ...
  \stemNeutral
  \saNormal
  \bendAfter #-2 a2.^\p^\espressivo
  \time 3/8
  R4. |
  \time 3/4
  \stemNeutral
  \saNormal
  \bendAfter #-2 a2.^\espressivo
  \time 3/8
  R4. |
  \time 3/4
  \stemNeutral
  ...
  \cricket
  \berioGoalposts
  r8. c'16^\f^\babbleFRENCH e16 c r c \bendAfter #-2 g8. r16 \acciaccatura { \cross c16^\rireFRENCH  } \cross c \cross c \cross c \cross c |
  ...
  \stemNeutral
  \time 4/4
  r4^\vacuumoffFRENCH d,4^\mp r8 d r4 |
  r4 d4 r8 d fis e |
  r4 d4 r8 d r4 |
  r4 d4 r8 d fis e |
  r4 c4 r8 c r4 |
...
%}
  ...
  \time 2/2
  \normal \clef "treble"
  c8^\mp^\< b c d e dis e f g fis g a bes^\f r4. |
  a4-.^\mp a-. a-. a-. |
  a4-. \times 2/3 { a8 r8 \cricket c,^\tapefastFRENCH } \times 2/3 { c c c } r16 \cross c8.:32^\rireFRENCH |
  ...
  \time 2/2
  \footnote "" #'(0 . 0) #'NoteHead  \tappingFRENCH 
  \bendAfter #-3 e,1^\turnoffFRENCH |
  R1 |
  R1 |
  R1 |
  R1 |
  ...
  bes c ees f g bes c ges f ees |
  bes c ees f g bes c ges f ees |
  \cricket r4 c8^\lambFRENCH \bendAfter #-2 c2.. |
  \cricket r4 c8 \bendAfter #-2 c2.. |
  \saNormal
...
tenor = \relative c' {
  ...
  \new Staff \with {
      ...
      \override VerticalAxisGroup #'staff-staff-spacing = #'((basic-distance . 3)
       (minimum-distance . 3)
       (padding . 2))
    } \relative c' { \clef percussion \cricket \override NoteHead #'style = #'cross \stemUp \footnote "" #'(0 . 0) #'NoteHead "* Les rythmes tapés sur la poitrine sont toujours exécutés tutti." c16^\f^\markup { \italic { "en tapant sur la poitrine" } }^"*" [ c c] \repeat unfold 9 { c16[ c c] } }
  >>
  \time 2/8
  R4 |
  \time 3/8
  ...
  \time 5/4
  \stemUp \cricket
  \cross c,8.^\p^\gongFRENCH \cross c \cross c \cross c \cross c \cross c \cross c8 |
  \time 5/8
  \stemNeutral \berioGoalposts
  \times 2/3 { c'16 c c } \times 2/3 { c c c } \times 2/3 { c c c } \times 2/3 { c c c } \times 2/3 { c c c } |
  \time 3/4
  \times 2/3 { c c c } \stemUp \cricket \cross c,8.^\p^\gongFRENCH \cross c \cross c \cross c16 |
  \tNormal
  \stemNeutral
  g4 \cricket \cross c8^\mouthclickFRENCH \tNormal g d4 \cricket \cross c'8 \tNormal g ~ |
...
%}
  ...
  R2. |
  \time 2/2
  \cricket \clef percussion r2. c'4^\pekingFRENCH ~ |
  c2 r4 e4 ~ |
  e2 r2 |
  d2 ~ d8 f4. |
  r4 e2 e4 |
...
bass = \relative c' {
  ...
  \MonoShift
  \override TextScript #'whiteout = ##t
  s1-"Attention K-Mart shoppers."
  s1-"Today's Blue Light"
  s1-"Special can be found in"
  s2-"asile seven." s2
  ...
  R1*5/8\! |
  \time 5/4
  f4^\< \times 2/3 { g8 b a ~ } a8 g16^\> g g g a8 g16 g \bendAfter #-2 g8\! |
  \time 5/8
  R1*5/8
  \time 3/4
