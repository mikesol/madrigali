...
welcome = \tempo 4=140
secret = \tempo 4.=160
secretQuarter = \tempo 4=160
debut = \tempo 4=120
debutSlower = \tempo 4=108
...
sopranoBeginning = \relative c'' {
  ...
  fis4 gis8 b4 gis8 fis4 gis8 e4 r8 cis4 e8 r |
  fis4 gis8 b8 r4 |
  R1*5/8 |
  r8. a16^\mf^\shakyFRENCH ~ a8 ~ a16 gis ( fis8 ) r |
  ...
  \cricket r4.. c,16^\markup \italic "giggly" c c8. c8. c16 |
  ...
  r2.^\fermata r4 |
  R1 |
  \times 4/5 { r16 e,16^\p gis, a gis } \times 4/5 { b fisis gis r8 }  r4 r16 b'8.^\f ~ |
  ...
  R1 |
  R2 |
  fis4^\f gis8 b4 gis8 fis4 gis8 e4. |
  fis4. e d fis4 a |
  a,4. r4 |
  \cricket
  r8 c4 ~ c2. ~ |
  ...
  cis4^\mf ) r4 r16 b^\p r8 \cricket r8 c,16^\mf c |
  c c8. r4 r2 |
}
...
sopranoWordsBeginning = \lyricmode {
  ...
  \repeat unfold 2 { cra -- zy love is what I'm done and you }
  cra -- zy lo
  oh my
  nine and five
  oh God
...
altoBeginning = \relative c''' {
  ...
  R2 |
  R2 |
  \saNormal \times 2/3 { r4 e8 } \times 2/3 { gis,8 a gis }
  b8. fisis16 ~ fisis8 \cricket \tri c' |
  \saNormal r2. e16 gis, a gis |
...
tenorBeginning = \relative c' {
  ...
  c8. c r4. r8. c^\mf^\markup \italic "croassement" |
  c8. r r2. |
  R1*12/8 |
  r4 r16 c8 r16 |
  R2 |
...
bassBeginning = \relative c' {
  ...
  r32 b16. r8 b4^- ( \glissando a'8^. ) bes,8 \times 2/3 { fis'8 a,4^-\bendAfter #3  } |
  r16 ees'8.^- ( \glissando \times 2/3 { a,4 ) gis8 } \times 2/3 { g fis fis ~ } \times 4/5 { fis^-\bendAfter #2  \cricket \tri c'^. \tNormal f,16 ~ } |
  ...
  c c c c r8. \saNormal g'''16^\mp^\markup \italic "squeak" ~ g4 ~ |
  g1 |
  \bNormal r2 r8 f,,,4^\mf f8 |
