...
%% MIRKKU  - show beat on triples, no half note triplets in jazz
\version "2.14.0"
...
prayer = \markup \italic \column { "interspersed with hebrew" "prayer and flexitone" }
horse = \markup \italic \column { "falling" "horse sound" }
seal = \markup \italic \column { "rising" "seal sound" }
prayerMark = \markup \italic \column { "rabbi and flexitone" "ad libitum" }
...
marksFaithful = \relative c' {
  ...
  s1 |
  \time 5/4
  s2.. \set Score.tempoWholesPerMinute = #(ly:make-moment 15 4 0 1) s8   \tempo "whimsical" 4=44 s4 |
}
...
sopranoFaithful = \relative c' {
  ...
  cis2. |
  R2. |
  d4^\mp fis'^\mf \times 4/5 { cis8 e4 b8 d8 }
  \times 4/5 { a cis fis, g b ~ } b a4 r8^\fermata r4 |
}
...
altoFaithful = \relative c' {
  ...
  r4 b'2^\mp |
  fis1 ~ |
  fis4. r8 r2^\fermata \times 2/3 { r8 cis cisis } |
}
...
mikeHolyShit = {
  #(skip-of-length sopranoHolyShit)
}
...
marksUbiquitous = {
  ...
  \time 4/4
  \tempo "the elephant's instep" 4=150
  s1 |
  \time 3/4
  s2. |
...
marksCat = {
  ...
  \once \override Score . RehearsalMark #'self-alignment-X = #CENTER
  \mark \markup \fontsize #-2 { \note #"4" #UP = \note #"16" #UP }
  \set Score.tempoWholesPerMinute = #(ly:make-moment 87 4 0 0)
  s8 \mark \markup \italic { "poco accel." } s4 s4. |
  \tempo "waltz" 4=99 
  s2.*8 |
  \set Score.tempoWholesPerMinute = #(ly:make-moment 60 4 0 1)
  s2. |
}
...
marksEnd = {
  ...
  s4
  \set Score.tempoWholesPerMinute = #(ly:make-moment 10 4 0 1)
  s4*1/3
  \set Score.tempoWholesPerMinute = #(ly:make-moment 44 4 0 1)
  s4*2/3
  \set Score.tempoWholesPerMinute = #(ly:make-moment 36 4 0 1)
  s4
  \set Score.tempoWholesPerMinute = #(ly:make-moment 20 4 0 1)
  s4*1/3
  \set Score.tempoWholesPerMinute = #(ly:make-moment 44 4 0 1)
  s4*2/3 |
  s1 |
...
mikeUbiquitous = {
  #(skip-of-length sopranoUbiquitous)
}
...
sopranoCat = \relative c'' {
  ...
  r8 \cricket c8 \xx r8 \saNormal e4^\p \yy e8 | % shift this up later if nec.
  \xx e8 \yy e e4 e e |
  \xx e8 e4 e e \yy e8 |
  e4 e e e |
  \xx e8 e4 e r4 \yy r8 |
...
sopranoEnd = \relative c'' {
  gis4^\mp^\fermata r^\fermata a^\fermata r |
...
sopranoWordsCat = \lyricmode {
  ...
  Nor -- man
  you're my love oh you're my one and on -- ly Nor -- man
  and you are Nor -- man
  Ro
  %Nor -- man, he stopped and he tied his shoe.
  %man Nor -- man Ro -- sen, I thought you were -- n't watch -- ing
}
...
altoCat = {
  \relative c'' {
    ...
    \times 2/3 { r4 b^\p^\< c } \times 2/3 { cis d^\mf r8 cis'8 }
    a8 r8 r2 |
    r4 \xx r8 e4^\p \yy e8 |
    \xx e8 \yy e e4 e e |
    \xx e8 e4 e e \yy e8 |
    e4 e e e |
    \xx e8 e4 e e \yy e8 |\pocoapoco 
    \xx e8^\< \yy e e4 e e |
    \xx e8 e4 e e \yy e8 |
    e4 e2 cis4 |
    e cis'2 a4 |
...
altoEnd = \relative c' {
  dis4^\fermata \times 2/3 { r8^\fermata cis cisis } dis4^\fermata \times 2/3 { r8 cis cisis } |
  dis4. disis8 eis4. r8 |
  cis4^\mf^\> c b4.^\< d8 |
...
altoWordsCat = \lyricmode {
  ...
  bi -- qui -- tous Nor -- man
  \repeat unfold 5 { Ro -- sen -- blatt }
  yes it's Nor -- man Ro -- sen -- blatt
  rat tat tat tat tat
  Nor -- man Ro -- sen -- blatt
  Ro -- sen -- blatt
  go Nor -- man Ro -- sen -- blatt % trips
  Nor -- man took her hand and helped her
  cross the road
  Nor -- man, Nor -- man
  yes I saw you
  You'll ne -- ver know how much I Nor -- man
  Nor -- man Ro -- sen Nor -- man
  push -- ing up the dai -- sies
  %Nor -- man, he stopped and he tied his shoe.
  %Nor -- man
}
...
tenorCat = {
  \relative c'' {
    ...
    R2 |
    R2 |
    r8 gis16 cis b g ees bes' a f c gis' | %{ R2. %} |
  }
  r4 \xx r8 e'4^\p \yy e'8 |
  \xx a8 \yy a a4 ais ais |
  \xx b8 b4 cis' cis' \yy cis'8 |
  a4 a4 ais ais |
  \xx b8 b4 cis' cis' \yy cis'8 |\pocoapoco 
  \xx a8^\< \yy a a4 a a |
...
tenorEnd = \relative c' {
  cis4^\mp^\fermata r^\fermata c^\fermata r |
...
tenorWordsCat = \lyricmode {
  ...
  rat tat tat tat
  tat tat tat tat
  man -- ners and a ban -- ner on the go
  he was a Nor -- man Ro -- sen
  Ro -- sen -- blatt
  Nor -- man how I cra -- zy
  Nor -- man rea -- ding tea leaves in his cof -- fee
  Nor -- man Ro -- sen -- blatt, it's cra -- zy how I know
  No one else but Nor -- man, Nor -- man Ro -- blatt,
  took the time, time to write me Nor -- man
  %Nor -- man, he stopped and he tied his shoe.
  %man
}
...
bassEnd = \relative c' {
  ais4^\mp^\fermata r^\fermata a^\fermata r |
  gis2.^\espressivo r4 |
  ais^\mf^\> a gis4.^\p r8 |
  b4^\< cis, fis, fis' |
...
sopranoBeginning = \relative c'' {
  ...
  gis fisis gis ais b ais b cis r8 %}
  R1 |
  r2 r8 b4 ~ \bendAfter #-2 b8 |
  r4 r4. gis,8. ais ~ |
  ais g' ~ g f ees des16 ~ |
  des8 c8. bis8. r4. gis8 ~ |
  gis16 ais8. eis'8. bis4. gis'8. ~ |
  gis16 dis e fis gis fis gis a r8 
  g'4^\sfz r8 |
  g4^\sfz r8 g4^\sfz r8 g4^\sfz |
}

mikeBeginning = \relative c {
  \key b\major
  \clef "treble_8"
  %3/4
  R2.
...
mikeWords = \lyricmode {
  ...
  chea -- per than a kil -- ler mon -- key.
  \repeat unfold 8 foo
  sky is bur -- ning and I'm run -- ning out of pea -- nut but -- ter.
}
...
%{  R1 |
  ...
  des8 c8. bis8. r4. gis8 ~ |
  gis16 ais8. eis'8. bis4. gis'8. ~ |
  gis16 dis e fis gis fis gis a r8 %} c4^\sfz r8 | % bring this down if change
  ...
  \new ChoirStaff <<
    \new Staff \with { instrumentName = #"Marie" %shortInstrumentName = #"M."
      ...
      \new Voice = "soprano" { #(set-accidental-style 'neo-modern) \numericTimeSignature << { \set Staff.midiMaximumVolume = #1.0
        \sopranoBeginning \sopranoHolyShit \sopranoUbiquitous \sopranoHighHigh \sopranoCat \sopranoFaithful \sopranoEnd } { \marksBeginning \marksHolyShit \marksUbiquitous \marksCat \marksFaithful \marksEnd } >> }
      \lyricsto "soprano" \new Lyrics { \sopranoWordsBeginning \sopranoWordsHolyShit \sopranoWordsUbiquitous \sopranoWordsCat \sopranoWordsFaithful \sopranoWordsEnd }
    >>
    \new Staff \with { \override VerticalAxisGroup #'staff-staff-spacing = #'((basic-distance . 1)
      ...
      \lyricsto "alto" \new Lyrics { \altoWordsBeginning \altoWordsHolyShit \altoWordsUbiquitous \altoWordsCat \altoWordsFaithful \altoWordsEnd }
    >>
%{    \new Staff \with { instrumentName = #"Mike" %shortInstrumentName = #"Mk."
    ...
    \new Staff \with { instrumentName = #"Ryan" %shortInstrumentName = #"R."
      ...
      \lyricsto "tenor" \new Lyrics { \tenorWordsBeginning \tenorWordsHolyShit \tenorWordsUbiquitous \tenorWordsCat \tenorWordsFaithful \tenorWordsEnd }
    >>
    \new Staff \with { instrumentName = #"Eudes" %shortInstrumentName = #"P." %\markup { \concat { E \super u . } }
      ...
      \lyricsto "bass" \new Lyrics { \bassWordsBeginning \bassWordsHolyShit \bassWordsUbiquitous \bassWordsCat \bassWordsFaithful \bassWordsEnd }
    >>
  >>
  \layout {
    \context {
