...
falsettoFRENCH = \markup \italic "voix de faussée"
...
cymbalFRENCH = \markup \italic \general-align #Y #CENTER { \musicglyph #"noteheads.s2xcircle" = cymbale }
...
preggoText = { s4^"oracle," s4^"I'm" s4^"pregnant" s4^"with" s4^"your" s4^"star"}
starDollarText = {   s4^"You" s4^"give" s4^"me" s4^"star," s4^"I" s4^"give" s4^"you" s4^"five" s4^"dollar." }
...
marks = {
  ...
  \question
  \cadenzaOn
  #(ly:export (skip-of-length powerText))
  #(ly:export (skip-of-length nineStarsText))
  s4 \bar "|"
  \cadenzaOff
  \time 4/4
  s1
  ...
  s1 |
  \cadenzaOn
  #(ly:export (skip-of-length preggoText))
  #(ly:export (skip-of-length starDollarText)) \bar "|"
  \cadenzaOff
  \time 2/4
  s2 |
  \cadenzaOn
...
soprano = \relative c''' { #(set-accidental-style 'neo-modern)
  \autoBeamOff
  #(ly:export (skip-of-length tperc))
  R1 |
  R1 |
  b2....^\ppp^\fermata r32 |
  R4. |
  ...
  \saNormal
  \times 2/3 { e'8-| \ziggliss d,2 ( \glissando d''8-. ) }
  \times 2/3 { \ziggliss d,,2 ( \glissando d''8-. ) \tri b,8-| %{tch%} } |
  R1
  R1
  R2.
  R2
  ...
  \stemNeutral
  #(ly:export (skip-of-length preggoText))
  #(ly:export (skip-of-length starDollarText))
  R2
  s4*5
  \cricket
  ...
  \tri \bendAfter #3 c,8^\mf \tri \bendAfter #-2 c16 c
    \saNormal c-| f'-| aes-| bes^\p\<^\lightSaberFRENCH \glissando (
  ...
  R1 |
  r2. r4^\fermata |
  %\override Glissando #'stencil = #(lambda (grob) (vibster grob 5 0.005 '((10 10 20 20 30 30) (10 10 10 10 10) (10 10 10 10 10) (10 10 10 10 10))))
  c'4^\p\glissando s2. |
  s1 |
  s2 des8 r8 r4 |
  ...
  \times 8/10 { f16-. d'32 b a16-| b'-| f-| }
    \times 4/5 { c a'32 f b, } 
      \times 4/5 { \cricket \tri c,32 \tri c \saNormal \once \override Hairpin #'stencil = #(lambda (grob) (vibster grob 0 0.05 alto-one))
  \once \override Hairpin #'normalized-endpoints = #ly:spanner::calc-normalized-endpoints      
      \once \override Hairpin #'extra-offset = #'(0 . -4.6)
      des''16.^\< } s4 s4 |
  s2.. des8\!-. ais16^\mf\> ( \glissando dis,32\p ) dis^\< fis16-| ais-|^\mf
    \times 2/3 { fis32 fis16.^\sfp\< \glissando d8 \glissando a'^\f }
    \times 2/3 { f8-|^\mp g e16^\f \glissando c \glissando }
    s16 %{ GLISS HERE %} aes' c,-| c-| |
  ...
  bes32 aes g aes des ces bes g
    ...
    \times 4/6 { fis8-|^\mp\< gis16 ais gis c-| }
    \times 4/5 { \cricket \tri c, \saNormal c' des aes ges^\f }
  \cricket \tri c,32 \tri c \saNormal ees \cricket \tri c \saNormal g''16-| \cricket \air c,, \saNormal % ugh, use unpure pure container here...
  ...
  \times 4/7 { dis16^\< ais' gis eis cis \feelingLucky
   ...
   \times 2/3 { ais32 \cricket \tri c,32 \saNormal a'8 bes, c16 } \times 4/6 { e g e \cricket \tri c8-| \saNormal d''16^\mp ( }
   e8 ) e,,-| \once \override Hairpin #'normalized-endpoints = #ly:spanner::calc-normalized-endpoints
      \once \override Hairpin #'stencil = #(lambda (grob) (vibster grob 0 0.05 '((9 0 20 5 30 -1) (10 12 8 10 15) (10 10 4 10 -10))))
      % \blech...
      \once \override Hairpin #'extra-offset = #'(0 . -1.8)
      d''4^\p^\< |
  s1 |
  s1
  c4\! r4 r2 |
  R1 |
  \cricket
  r4 r16 c,,8^\f^\lowVoiceFRENCH c16 r4. \feelingLucky \clef treble
  ...
  r8 c^\mp \saNormal c'16^\pp r8 \cricket c,16^\mp ~ c r8. \saNormal \times 4/5 { g''8. c8-| } |
  \times 4/5 { b16 a8-| e8-| } r8. \cricket \tri c,16^\p ~ \tri c \tri c8 r16 r4 |
  R1*4 |
}
...
sopranoGlissando = \relative c'' {
  ...
  s4 s8 s8*2/5 s8*3/5^\mp\< \stemDown e4 e |
  e f f e8 s8^\f |
  s2. \stemDown e,16 s8. |
  s1*3
...
%  #(make-spermazoid (crude-bloat-x '((100 10 50 30 70 20) (50 40 -20 40 0) (50 40 40 40 20) (50 40 0 40 20) (50 40 60 40 40) (50 40 20 40 40) 20) 6) '(4 . 0.9) '(3 . 0.4) #f (lambda (x) (/ x 4)))
  ...
  s4^"You" \bar "" s4^"give" \bar "" s4^"me" \bar "" s4^"star," \bar "" s4^"I" \bar "" s4^"give" \bar "" s4^"you" \bar "" s4^"five" \bar "" s4^"dollar."
...
%  }
  ...
  \cricket r8 c,16^\mf \saNormal ees32-| des'-|
    r16 \cricket c,16-|
      \goalposts \stemTrans
      \clef treble
      \once \override NoteHead #'stencil =
  ...
  r8. \once \override Hairpin #'normalized-endpoints = #ly:spanner::calc-normalized-endpoints
      \once \override Hairpin #'stencil = #(lambda (grob) (vibster grob 0 0.05 '((9 0 20 -10 30 10) (10 10 0 10 -15) (10 10 -8 10 15))))
      % \blech...
      \once \override Hairpin #'extra-offset = #'(0 . -4.8)
      des16^\< s4 s4 s4 |
  s1 |
  ...
  \times 4/6 { b'16 a gis fis8 gis32 ( \glissando dis ) }
    ...
    \bendAfter #-2 bis32-| eis,,16 cis d32 d fis
    \times 2/3 { e8^\> d e\mp } |
  \feelingLucky
  r8
  \stemDown
  ...
  \cricket \stemDown c4^\veryhighFRENCH \stemUp c,16^\laughterFRENCH c16 c16
  \stemNeutral
  \saNormal cis^\mp ( \glissando
    s8*4/6 %{GLISS%} cis'16*4/6 ) fis,16*4/6 dis16*4/6 e16*4/6 fis'16 a, f!8->^\f\glissando |
  \times 8/9 { e'32 cis^\p dis, e ais16-| bis32.^\f gis }
    dis16 e dis''^\pp bis^\< \glissando
    s16 s32 %{GLISS%} e,,32^\f e16 f
    cis^- e dis dis
  \times 4/6 { cis'^\mp cis'8-| a16 ais8^\sfp\< \glissando }
  ...
  \times 4/6 { cis'16-| cis-| ais,-| gis8-| ais'16 }
  ...
  \times 4/5 { r8 f16^\mf cis b }
    b g'8 \glissando b,32 cis b8-| cis-> \glissando (
  ...
  r2.
  \footnoteGrob #'NoteHead #'(0 . 0) "" \appoxFRENCH
...
%  b,8 ais b c c^\f ees f ees |
  ...
  \times 2/3 { \tri c8-. %{ç%} \saNormal d'16 %{ni%} \cricket \tri c, %{p%} \tri c16-. %{t%} r32 \saNormal \hairlen #4 b''^\p\< %{di%} ~ }
    ...
    \times 4/5 { e'8-| %{ih%} dis'-| %{fiht%} \hairlen #4 e16^\p\< %{di%} \glissando }
    d,,8\f %{ou%} \cricket \tri c16 %{ɬ%} \tri c %{ɬ%} 
  \times 4/5 { \tri c8-|^\mf  %{t%} \feelingLucky
...
%      \once \override TupletNumber #'text = #(markup #:note "8" UP)
  ...
  \tri c8-| %{t%} \tri c32 \tri c32 \tri c32 \tri c32 %{d m d m%} 
    ...
    \cricket \tri c,,8-| %{t%} \saNormal fis16-.^\mf^\espressivo %{dim%} \cricket \tri c16
  ...
  \unFatText \unMonoShift
  \revert TextScript #'whiteout
  #(ly:export (skip-of-length nineStarsText)) \tNormal bes4^\espressivo^\mf
  R1 |
  R1 |
  R2 |
  \cricket
  ...
  \revert TupletNumber #'text
  \revert TupletNumber #'Y-offset
  r4. \times 2/3 { r8 c'16^\mf } \times 4/6 { c c r r8 c16 } \times 4/6 { c c c c r c } |
...
\stemDown
  ...
  r8 c'8 \times 2/3 { d,8 ( a'8. ) r16 } fis,4.^\espressivo^\generatorFRENCH \feelingLucky
     \once \override NoteHead #'stencil = #(make-spermazoid-rel '((37 60 41 63 42 65 )(31 36 70 41 74 )(41 46 74 49 79 )(64 51 80 54 83 )(58 54 83 55 83 )41) '(5 . 0.690196564439) '(4 . 0.730624021345) #t (lambda (x) (/ x 4)))
         b4*1/2 \cricket |
  \tri c4^\ff \tNormal \times 8/9 { d8^\mp^\closedFRENCH ( \glissando gis16-. ) a b c e,8^\< ( \glissando a16\f ) } a \cricket \tri \footnoteGrob #'NoteHead #'(0 . 0) "" \upsideDownFRENCH c,^"*" \tri c \tri c |
  ...
  r16 gis''8.^\insistFRENCH ~ gis8 \times 2/3 { r16 e,,16 r } \times 2/3 { e r8 } bes'16 g ~ \times 4/5 { g e-| r8. } |
...
bass = \relative c' { #(set-accidental-style 'neo-modern)
  ...
  \times 2/3 { r8 \saNormal g''8-|^\mf^\consonantFRENCH a,-| }
    \times 2/3 { bes-| f'-| bes,-| }
  ...
  \times 2/3 { d'8 d, d, }
    b8 \feelingLucky \once \override TupletNumber #'text = #(markup #:note "4." UP) \times 1/1 { r16 
     \once \override NoteHead #'stencil =
       ...
       d4*5/4 }
     \saNormal gis'16-|^\mf ais-| dis,,-| cis-| %{tchu tchu tchu tchu %}
  \times 2/3 { a''8-| b4 }
  ...
  \times 2/3 { b'4^\f^\moreSpitFRENCH d8 }
    r4
    \footnoteGrob #'NoteHead #'(0.5 . 0.5) "*" \kFRENCH
    \tightG c8.*1/3 \glissando \hideNotes a16 \glissando c16 \unHideNotes r16 \normalG
    c4-|^\sfz
  c4
    r16 e8.
    r4
    \footnoteGrob #'NoteHead #'(0.5 . 0.5) "†" \hFRENCH
    \times 2/3 { b4^\sfz d8 }
  ...
  \saNormal e''16. ( \glissando fis,,32 ) \cricket \tri c32 \tri c \tri c \tri c
    ...
    \times 4/6 { \cricket \tri cis-| \tNormal cis-| f-| b-| gis-| e'-| } \times 2/3 { a,-| r \cricket c,8-- c-- }
  r2. r8 \times 2/3 { r8 }
  \feelingLucky
  \clef bass
  \once \override TupletNumber #'text = #(markup #:note "2" UP)
  ...
  %  #(make-spermazoid '((60 90 50 30 70 50) (50 40 100 80 180) (30 10 210 10 215) 10) '(4 . 0.9) '(3 . 0.4) #t values)
    ...
    #(ly:stencil-rotate (make-spermazoid '((260 0 250 10 200 50) (200 40 100 80 180) (30 10 210 10 215) (30 40 210 40 300) (100 40 430 50 480) 10) '(5 . 0.4) '(3 . 0.1) #t (lambda (x) (sqrt x))) 15 0 0)
    e4
  } \stemNeutral \cricket c'4^\f^\fryFRENCH ~ |
  c2 ~ c8 r8 r4 |
...
%%%%% m. 79
  ...
  \once \override NoteHead #'stencil = #(make-spermazoid-rel '((46 54 48 54 52 58 )(56 42 59 44 59 )(38 44 60 49 62 )(37 51 63 54 65 )(54 55 67 56 68 )50) '(5 . 0.170817307394) '(4 . 0.498845991841) #t (lambda (x) (/ x 1)))
    b4*2^\mf^\markup \fontsize #-2 \parenthesize \note #"2" #UP r4 \bNormal ais,^\mp ( \glissando |
  fis4. \glissando a8 ) \cricket c8^\p c16 c c \feelingLucky
  \clef treble
